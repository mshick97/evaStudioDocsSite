    ...
    <div id='hero'>
      <section id='heroSection'>
        ...
        <div className='heroHeadingWrapper'>
          ...
          <br />
          <h3 className='h3Head spaceMonoFont'>evaStudio is an open-source, Apache Kafka playground for monitoring performance metrics in real time to test loads, decide on resources to provision, and improve processing efficiency before launching.
            <br />
            <br />
